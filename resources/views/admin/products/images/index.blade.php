                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form method="post" action="">
                                ...
                                <button type="submit" class="btn btn-danger btn-round">Borrar imagen</button>
                                @if ($image->featured)
                                    <button type="button" class="btn btn-info btn-just-icon" rel="tooltip" title="Imagen destacada de este producto">
                                        <i class="material-icons">favorite</i>
                                    </button>
                                @else
                                    <a href="{{ url('/admin/products/' . $product->id . '/images/featuredimage/' . $image->id) }}" class="btn btn-primary btn-fab btn-fab-mini btn-round">
                                        <i class="material-icons">favorite</i>
                                    </a>
                                @endif
                            </form>
