                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="td-actions text-right">
                                    ...
                                    <!-- Esto es para borrar de forma insegura con un get, se debe hacer
                                        con un POST!!
                                ...
                                -->
                                <!-- Así se borra con el método post, mas abajo lo hago con el método DELETE
                                    ...
                                    <!-- Formulario para borrar con DELETE -->
                                    <form method="post" action="{{ url('/admin/products/' . $product->id) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        <!-- La línea que viene a continuación es lo mismo que la anterior
